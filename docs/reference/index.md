...
- [Workflow-gate hooks (#415/#657)](workflow-hooks.md) — the seven workflow hooks, hard vs soft, the audit log + how to tune the step-3.5 hard gate; why the review loop is telemetry-only, and the instruction-budget ratchet.
