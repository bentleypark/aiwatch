...
const SERVICES: ServiceConfig[] = [
  ...
  { id: 'openai', name: 'OpenAI API', provider: 'OpenAI', category: 'api', statusUrl: 'https://status.openai.com', apiUrl: 'https://status.openai.com/api/v2/summary.json', incidentExclude: ['chatgpt', 'sora', 'excel plugin', 'deep research', 'workspaces', 'logged out', 'support chat'], incidentIoBaseUrl: 'https://status.openai.com/incidents' },
