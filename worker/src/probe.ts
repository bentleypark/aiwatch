...
export const PROBE_TARGETS: ProbeTarget[] = [
  ...
  // Not feasible: bedrock (no public endpoint), azureopenai (tenant-specific), pinecone (index-specific), modal (no public API), langsmith (API requires auth), runway (API requires auth)
]
