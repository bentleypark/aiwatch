...
<script type="application/ld+json">
{
  ...
  "description": "Real-time status monitoring for 28 AI services including Claude, ChatGPT, Gemini, and Cursor. AI-powered incident analysis with fallback recommendations.",
...
<div class="hero-2col">
  <div class="hero-left">
    ...
    <div class="hero-pills">
      <div class="stat-pill"><span class="stat-pill-num">28</span> <span data-i18n="hero.pill1">AI 서비스</span></div>
  ...
  <div class="dashboard-mock">
    ...
    <div class="mock-body">
      ...
      <div class="mock-stats-row">
        <div class="mock-stat-card stat-green"><div class="mock-stat-value" style="color:var(--green);">27</div><div class="mock-stat-sub">services running</div></div>
      ...
      <div class="mock-section-header">
        ...
        <div class="mock-filter-tabs">
          <span class="mock-filter-tab active">All 28</span>
          <span class="mock-filter-tab">Operational 27</span>
      ...
      <div class="mock-cards">
        ...
        <div class="mock-card ok" style="opacity:0.4;padding:10px 14px;grid-column:1/-1;">
          <div style="font-size:12px;color:var(--text2);text-align:center;" data-i18n="demo.more">+ 25개 서비스 더 보기...</div>
        </div>
      </div>
...
<section class="report-section" id="report">
  ...
  <p class="section-sub" data-i18n="report.sub">매월 28개 서비스의 AIWatch Score 순위, 인시던트 요약, 공식 업타임, 주요 장애 분석, 프로바이더 추천까지 한 리포트로 공개합니다.</p>
...
const i18n = {
  ko: {
    ...
    'demo.title': '장애 파악부터 대안 선택까지', 'demo.sub': '지금 어떤 서비스가 안정적인지, 장애 중이라면 대안은 무엇인지 한 화면에서 파악합니다', 'demo.more': '+ 25개 서비스 더 보기...',
    ...
    'compare.title': '공식 상태 페이지와 무엇이 다른가요?', 'compare.sub': '공식 페이지 데이터를 기반으로, 28개를 한 화면에서 통합합니다', 'compare.col1': '공식 상태 페이지', 'compare.r2': '장애 알림', 'compare.r2a': '직접 확인 필요', 'compare.r2b': 'Discord · Slack 즉시 발송', 'compare.r3': 'AIWatch Score', 'compare.r3a': '서비스별 개별 확인', 'compare.r3b': 'AIWatch Score — Uptime + 영향 일수 + 복구 시간', 'compare.r4': '장애 분석', 'compare.r4b': 'AI가 원인 · 복구 시간 분석', 'compare.r5': '대안 추천', 'compare.r5b': 'Fallback 서비스 즉시 제안', 'compare.r6': '월간 리포트', 'compare.r6b': '매월 리포트 공개', 'compare.r7': '비용', 'compare.r7a': '무료', 'compare.r7b': '완전 무료 · 오픈소스',
  ...
  en: {
    ...
    'demo.title': 'From outage detection to fallback — in one view', 'demo.sub': 'See which services are stable right now — and what to use instead when they\\\'re not', 'demo.more': '+ 25 more services...',
    ...
    'report.title': 'Monthly AI Reliability Report', 'report.hook': 'Which AI service is most reliable? The answer may surprise you.', 'report.link': 'View All Reports →', 'report.sub': 'AIWatch Score rankings, incident summaries, official uptime, notable outage analysis, and provider recommendations — all in one monthly report for 28 services.', 'report.chart.note': '* Lower scores may reflect reporting granularity, not actual instability', 'ai.title': 'AI analyzes every incident', 'ai.sub': 'One step beyond status monitoring — Claude Sonnet instantly analyzes incident patterns, estimated recovery time, and impact scope.',
