...
<div id="ph-banner" style="display:${phDisplay};background:var(--green-dim);border-bottom:1px solid rgba(63,185,80,0.3);padding:10px 24px;text-align:center;">
  <span style="font-size:13px;color:var(--green);font-family:var(--font-mono);">
    👋 Welcome, Product Hunters! &nbsp;·&nbsp; If AIWatch is useful, an upvote means the world to us 🙏
  </span>
</div>
...
<div class="hero-2col">
  <div class="hero-left">
    ...
    <div class="hero-pills">
      <div class="stat-pill"><span class="stat-pill-num">25</span> <span data-i18n="hero.pill1">AI 서비스</span></div>
    ...
    <div class="mock-body">
      ...
      <div class="mock-section-header">
        ...
        <div class="mock-filter-tabs">
          <span class="mock-filter-tab active">All 25</span>
...
<section class="report-section" id="report">
  ...
  <p class="section-sub" data-i18n="report.sub">매월 25개 서비스의 AIWatch Score 순위, 인시던트 요약, 공식 업타임, 주요 장애 분석, 프로바이더 추천까지 한 리포트로 공개합니다.</p>
  ...
  <text x="200" y="186" text-anchor="middle" fill="#444" font-size="10">· · · 전체 25개 서비스 보기 → reports.ai-watch.dev</text>
</svg>
  </div>
...
const i18n = {
  ko: {
    ...
    'feat.1.title': 'AIWatch Score', 'feat.1.desc': '25개 서비스의 인시던트 빈도, 복구 시간, 업타임을 종합한 0~100점 AIWatch Score입니다. 서비스마다 흩어진 공식 데이터를 통합해 한눈에 비교할 수 있게 합니다. 단, 공식 데이터가 부족한 일부 서비스는 업계 평균치를 반영합니다.',
    ...
    'compare.title': '공식 상태 페이지와 무엇이 다른가요?', 'compare.sub': '공식 페이지 데이터를 기반으로, 25개를 한 화면에서 통합합니다', 'compare.col1': '공식 상태 페이지', 'compare.r2': '장애 알림', 'compare.r2a': '직접 확인 필요', 'compare.r2b': 'Discord · Slack 즉시 발송', 'compare.r3': 'AIWatch Score', 'compare.r3a': '서비스별 개별 확인', 'compare.r3b': 'AIWatch Score (0–100)', 'compare.r4': '장애 분석', 'compare.r4b': 'AI가 원인 · 복구 시간 분석', 'compare.r5': '대안 추천', 'compare.r5b': 'Fallback 서비스 즉시 제안', 'compare.r6': '월간 리포트', 'compare.r6b': '매월 리포트 공개', 'compare.r7': '비용', 'compare.r7a': '무료', 'compare.r7b': '완전 무료 · 오픈소스',
    'how.1.title': '수집', 'how.1.desc': '25개 공식 상태 페이지를 자동으로 수집',
    ...
    'report.title': '월간 AI 서비스 신뢰도 리포트', 'report.link': '전체 리포트 보기 →', 'report.sub': '매월 25개 서비스의 AIWatch Score 순위, 인시던트 요약, 공식 업타임, 주요 장애 분석, 프로바이더 추천까지 한 리포트로 공개합니다.', 'ai.title': '장애가 나면 AI가 분석합니다', 'ai.sub': '단순 상태 표시에서 한 발 더 — 장애 패턴, 예상 복구 시간, 영향 범위를 Claude Sonnet이 즉시 분석합니다.',
  ...
  en: {
    ...
    'report.title': 'Monthly AI Reliability Report', 'report.link': 'View All Reports →', 'report.sub': 'AIWatch Score rankings, incident summaries, official uptime, notable outage analysis, and provider recommendations — all in one monthly report for 25 services.', 'ai.title': 'AI analyzes every incident', 'ai.sub': 'One step beyond status monitoring — Claude Sonnet instantly analyzes incident patterns, estimated recovery time, and impact scope.',
