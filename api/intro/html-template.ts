...
function renderAnnouncementBanner(a: Announcement): string {
  ...
  // (no inline onclick), with a.id carried on data-ga-id.
...
<script type="application/ld+json">
{
  ...
  "description": "Real-time status monitoring for 41 AI services including Claude, ChatGPT, Gemini, Cursor, and Codex. AI-powered incident analysis with fallback recommendations.",
    ...
    <div class="mock-body">
      ...
      <div class="mock-section-header">
        ...
        <div class="mock-filter-tabs">
          <span class="mock-filter-tab active">All 41</span>
      ...
      <div class="mock-cards">
        ...
        <div class="mock-card ok" style="opacity:0.4;padding:10px 14px;grid-column:1/-1;">
          <div style="font-size:12px;color:var(--text2);text-align:center;" data-i18n="demo.more">+ 32개 서비스 더 보기...</div>
        </div>
      </div>
    ...
    <table class="compare-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="yes" data-i18n="compare.r2b">41개를 한 곳에서 — Discord · Slack · RSS</td>
        </tr>
        <tr>
...
<section class="report-section" id="report">
  ...
  <p class="section-sub" data-i18n="report.sub">매월 41개 서비스의 AIWatch Score 순위, 인시던트 요약, 공식 업타임, 주요 장애 분석, 프로바이더 추천까지 한 리포트로 공개합니다.</p>
...
<section class="cta-section">
  <div class="cta-box">
    ...
    <div class="cta-btns">
      ...
      <a href="https://ai-watch.dev/#settings" class="btn-secondary" style="font-size:14px;padding:12px 24px;" data-i18n="cta.btn2" data-ga="click_cta_alerts" data-ga-loc="landing_cta">알림 설정하기</a>
    </div>
    <div class="cta-rss">
...
const i18n = {
  ko: {
    ...
    'hero.sub': '41개 AI 서비스 상태를 한 화면에서.<span class="hero-sub-line"> AIWatch가 신뢰도를 랭킹하고 장애를 분석해,</span> 멈추는 순간 대안을 즉시 추천합니다. 무료 · 오픈소스 · 무가입.',
    ...
    'demo.title': '장애 파악부터 대안 선택까지', 'demo.sub': '지금 어떤 서비스가 안정적인지, 장애 중이라면 대안은 무엇인지 한 화면에서 파악합니다', 'demo.more': '+ 33개 서비스 더 보기...',
  ...
  en: {
    ...
    'hero.sub': 'Real-time status for 41 AI services in one view.<span class="hero-sub-line"> AIWatch ranks reliability, analyzes incidents,</span> and recommends an instant fallback the moment something breaks. Free & open source — no signup.',
...
try {
  ...
  // GA4 link clicks — wired from data-ga / data-ga-loc (+ optional data-ga-id), delegated on the document.
  document.addEventListener('click', function (e) {
    var el = e.target.closest('[data-ga]');
    if (!el || typeof gtag !== 'function') return;
    var p = { location: el.getAttribute('data-ga-loc') || 'intro', source: 'intro' };
