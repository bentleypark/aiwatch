...
<script type="application/ld+json">
{
  ...
  "description": "Real-time status monitoring for 43 AI services including Claude, ChatGPT, Gemini, Cursor, and Codex. AI-powered incident analysis with fallback recommendations.",
...
<div class="hero-2col">
  <div class="hero-left">
    ...
    <p data-i18n="hero.sub">42개 AI 서비스 상태를 한 화면에서.<span class="hero-sub-line"> AIWatch가 신뢰도를 랭킹하고 장애를 분석해,</span> 멈추는 순간 대안을 즉시 추천합니다. 무료 · 오픈소스 · 무가입.</p>
    <div class="hero-ctas">
    ...
    <div class="hero-pills">
      <div class="stat-pill"><span class="stat-pill-num">43</span> <span data-i18n="hero.pill1">AI 서비스</span></div>
  ...
  <div class="dashboard-mock">
    ...
    <div class="mock-body">
      ...
      <div class="mock-stats-row">
        <div class="mock-stat-card stat-green"><div class="mock-stat-value" style="color:var(--green);">34</div><div class="mock-stat-sub">services running</div></div>
      ...
      <div class="mock-section-header">
        ...
        <div class="mock-filter-tabs">
          <span class="mock-filter-tab active">All 43</span>
          <span class="mock-filter-tab">Operational 35</span>
      ...
      <div class="mock-cards">
        ...
        <div class="mock-card ok" style="opacity:0.4;padding:10px 14px;grid-column:1/-1;">
          <div style="font-size:12px;color:var(--text2);text-align:center;" data-i18n="demo.more">+ 34개 서비스 더 보기...</div>
        </div>
      </div>
    ...
    <table class="compare-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="yes" data-i18n="compare.r2b">42개를 한 곳에서 — Discord · Slack · RSS</td>
        </tr>
        <tr>
...
<section class="report-section" id="report">
  ...
  <p class="section-sub" data-i18n="report.sub">매월 42개 서비스의 AIWatch Score 순위, 인시던트 요약, 공식 업타임, 주요 장애 분석, 프로바이더 추천까지 한 리포트로 공개합니다.</p>
...
const i18n = {
  ko: {
    ...
    'hero.sub': '43개 AI 서비스 상태를 한 화면에서.<span class="hero-sub-line"> AIWatch가 신뢰도를 랭킹하고 장애를 분석해,</span> 멈추는 순간 대안을 즉시 추천합니다. 무료 · 오픈소스 · 무가입.',
    ...
    'demo.title': '장애 파악부터 대안 선택까지', 'demo.sub': '지금 어떤 서비스가 안정적인지, 장애 중이라면 대안은 무엇인지 한 화면에서 파악합니다', 'demo.more': '+ 34개 서비스 더 보기...',
    ...
    'compare.title': '공식 상태 페이지와 무엇이 다른가요?', 'compare.sub': '공식 페이지 데이터를 기반으로, 43개를 한 화면에서 통합합니다', 'compare.col1': '공식 상태 페이지', 'compare.r2': '장애 알림', 'compare.r2a': '제공사마다 개별 구독', 'compare.r2b': '43개를 한 곳에서 — Discord · Slack · RSS', 'compare.r3': 'AIWatch Score', 'compare.r3a': '종합 점수 없음 (업타임 %만)', 'compare.r3b': 'AIWatch Score — Uptime + 영향 일수 + 복구 + 응답성', 'compare.r4': '장애 분석', 'compare.r4b': 'AI가 원인 · 복구 시간 분석', 'compare.r5': '대안 추천', 'compare.r5b': 'Fallback 서비스 즉시 제안', 'compare.r6': '월간 리포트', 'compare.r6b': '매월 리포트 공개', 'compare.r7': '비용', 'compare.r7a': '무료', 'compare.r7b': '완전 무료 · 오픈소스',
    ...
    'report.title': '월간 AI 서비스 신뢰도 리포트', 'report.hook': '가장 안정적인 AI 서비스는? 답은 의외일 수 있습니다.', 'report.link': '전체 리포트 보기 →', 'report.sub': '매월 43개 서비스의 AIWatch Score 순위, 인시던트 요약, 공식 업타임, 주요 장애 분석, 프로바이더 추천까지 한 리포트로 공개합니다.', 'report.chart.note': '* 하위 점수는 리포팅 방식 차이일 수 있으며, 실제 불안정성을 의미하지 않습니다',
  ...
  en: {
    ...
    'hero.sub': 'Real-time status for 43 AI services in one view.<span class="hero-sub-line"> AIWatch ranks reliability, analyzes incidents,</span> and recommends an instant fallback the moment something breaks. Free & open source — no signup.',
    ...
    'demo.title': 'From outage detection to fallback — in one view', 'demo.sub': 'See which services are stable right now — and what to use instead when they\\\'re not', 'demo.more': '+ 34 more services...',
    ...
    'report.title': 'Monthly AI Reliability Report', 'report.hook': 'Which AI service is most reliable? The answer may surprise you.', 'report.link': 'View All Reports →', 'report.sub': 'AIWatch Score rankings, incident summaries, official uptime, notable outage analysis, and provider recommendations — all in one monthly report for 43 services.', 'report.chart.note': '* Lower scores may reflect reporting granularity, not actual instability',
