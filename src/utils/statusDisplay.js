...
// Scope: only the Statuspage summary.json paths set `sourceUnknown`. The AWS-Health and Azure-RSS
// fetch-failure paths do not, so bedrock/azureopenai still render a plain `degraded` when their source
