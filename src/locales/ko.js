const ko = {
  ...
  'svc.orUptime.title': 'OpenRouter 가용성',
  'svc.orUptime.window': '30분 롤링 · OpenRouter 라우팅 트래픽',
  'svc.orUptime.samples': 'Grok 모델 {n}개',
  'svc.orUptime.tooltip': 'OpenRouter가 최근 30분간 자체 xAI 라우팅 트래픽으로 측정한 값입니다 — xAI 공식 지표가 아니며, 다른 서비스에 표시되는 30일 가용성과 비교할 수 없습니다. OpenRouter → xAI 경로를 반영하므로 xAI가 정상이어도 OpenRouter 측 문제로 낮아질 수 있습니다.',
  'svc.orUptime.gated': 'OpenRouter가 현재 성능 저하 상태입니다 — 이 수치는 xAI가 아니라 OpenRouter의 라우팅을 반영할 수 있습니다.',
