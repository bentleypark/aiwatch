const ko = {
  ...
  'score.tooltip': 'Uptime, 인시던트 영향 일수, 복구 시간, API 응답성 기반 종합 점수',
  ...
  'score.no_probe': 'Probe 데이터 없음 — 점수 재배분 적용',
  ...
  'aboutScore.intro': 'AIWatch Score는 uptime, 인시던트 영향 일수, 복구 시간, API 응답성을 종합한 AIWatch 고유의 서비스 신뢰도 지표입니다. 100점 만점으로 30일 기준 데이터를 사용합니다.',
  ...
  'aboutScore.naDesc': '모든 서비스에 점수가 산정되며, Probe 데이터가 있는 서비스는 높은 신뢰도, 없는 서비스는 점수 재배분으로 낮은 신뢰도가 적용됩니다.',
  ...
  'aboutScore.sourceProbeValue': '공개 API 엔드포인트 직접 RTT 측정, 5분 간격 (19개 서비스)',
  ...
  'aboutScore.responsivenessIntro': 'API 엔드포인트에 5분 간격으로 직접 측정한 RTT(응답 시간) 데이터를 기반으로 응답 속도와 안정성을 측정합니다.',
  'aboutScore.speedFormula': '속도 (0~10): 10 × exp(−p50 / 400)',
