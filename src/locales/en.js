const en = {
  ...
  'svc.orUptime.title': 'OpenRouter Availability',
  'svc.orUptime.window': '30-min rolling · OpenRouter routing traffic',
  'svc.orUptime.samples': '{n} Grok models',
  'svc.orUptime.tooltip': 'Measured by OpenRouter from its own routing traffic to xAI over the last 30 minutes — not xAI\'s official metric, and not comparable to the 30-day uptime shown for other services. It reflects the OpenRouter → xAI path, so an OpenRouter-side issue can lower it even when xAI is healthy.',
  'svc.orUptime.gated': 'OpenRouter is currently degraded — this figure reflects OpenRouter\'s routing, not necessarily xAI.',
