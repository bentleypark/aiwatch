const en = {
  ...
  'incidents.zeroLengthRecord.note': 'The record this incident came from carries a single instant for both its start and its end, so how long it ran is not derivable. The time shown is that instant.',
