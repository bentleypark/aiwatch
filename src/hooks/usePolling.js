...
const SERVICES = [
  {
    id: 'claude', name: 'Claude API', provider: 'Anthropic', status: 'operational',
  ...
  {
    id: 'openai', name: 'OpenAI API', provider: 'OpenAI', status: 'degraded',
  ...
  {
    id: 'gemini', name: 'Gemini API', provider: 'Google', status: 'operational',
  ...
  {
    id: 'mistral', name: 'Mistral API', provider: 'Mistral AI', status: 'operational',
  ...
  {
    id: 'cohere', name: 'Cohere API', provider: 'Cohere', status: 'operational',
  ...
  {
    id: 'groq', name: 'Groq Cloud', provider: 'Groq', status: 'operational',
  ...
  {
    id: 'together', name: 'Together AI', provider: 'Together', status: 'operational',
  ...
  {
    id: 'perplexity', name: 'Perplexity', provider: 'Perplexity AI', status: 'operational',
  ...
  {
    id: 'huggingface', name: 'Hugging Face', provider: 'Hugging Face', status: 'degraded',
  ...
  {
    id: 'replicate', name: 'Replicate', provider: 'Replicate', status: 'operational',
  ...
  {
    id: 'elevenlabs', name: 'ElevenLabs', provider: 'ElevenLabs', status: 'operational',
  ...
  {
    id: 'xai', name: 'xAI (Grok)', provider: 'xAI', status: 'operational',
  ...
  {
    id: 'deepseek', name: 'DeepSeek API', provider: 'DeepSeek', status: 'operational',
