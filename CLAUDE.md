...
src/
  ...
  utils/        # analytics, calendar, time, pageContext, constants, webhookAlerts (browser relay of the worker's canonical alert feed to a user's Discord, #467/#475), webhookRegistration
