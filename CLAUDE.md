...
**AIWatch** is a React SPA that monitors 35 AI services in real time:
- **26 API services**: Claude, OpenAI, Gemini, Mistral, Cohere, Groq, Together, Fireworks, Cerebras, Perplexity, HuggingFace, Replicate, ElevenLabs, AssemblyAI, Deepgram, xAI, DeepSeek, OpenRouter, Bedrock, Azure OpenAI, Pinecone, Stability AI, Voyage AI, Modal, LangChain (LangSmith), Runway
...
api/
  ...
  is-down.ts        # "Is X Down?" Edge Function (33 services — excludes bedrock/azureopenai per #263)
